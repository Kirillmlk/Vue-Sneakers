...
<template>
    <div class="relative flex-col w-full border border-slate-100 rounded-xl p-8 cursor-pointer transition
    hover:shadow-xl hover:transform hover:-translate-y-2"
    >
        <div class="absolute top-8 left-8">
            <img :src="!isFavorite ? '/like-1.svg' : '/like-2.svg'"  alt="Favorite" @click="onClickFavorite" />
        </div>
